...
export default function FreeCompanyCard() {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <a
                //TODO: Reaplace readdy.ai link with actual link
                href="https://readdy.ai/home/fd15a5a4-ace7-46c4-b191-110ce699c87e/bd1554c1-bf38-4082-a3b6-c0cc41b4e774"
                data-readdy="true"
            >
                <button className="cursor-pointer bg-blue-700 hover:bg-indigo-700 text-white px-5 py-2 rounded-button font-medium whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-indigo-400">
                    Free Company
                </button>
            </a>
        </div>
